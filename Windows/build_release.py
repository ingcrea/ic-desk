...
def main():
    ...
    cmd_compile = f"mcs /target:winexe /win32icon:{ico_file} /out:{exe_file} /r:System.Windows.Forms.dll,System.Drawing.dll,System.ServiceProcess.dll,System.dll,System.Core.dll {cs_file} /home/ingcrea/github/ic-desk/Windows/DXGICaptureEngine.cs /home/ingcrea/github/ic-desk/Windows/DXGI_Interop_Scratch.cs"
    ...
    subprocess.run(f"git tag -a {version} -m 'IC-Desk {version} Release'", shell=True, cwd=repo_dir)
    ...
    release_payload = {
        ...
        "name": f"IC-Desk {version} Release",
        "body": f"### 🚀 Release IC-Desk {version}\n\n- Sincronización automática de versión en cliente, interfaz y servidor.\n- Ejecutable binario precompilado IC-Desk.exe adjunto en Assets.",
        "draft": False,
        "prerelease": False
    }
    ...
    try:
        with urllib.request.urlopen(req_upload) as resp_up:
            print("✅ Asset IC-Desk.exe subido exitosamente a GitHub Release")
    except urllib.error.HTTPError as e:
    ...
    print("🚀 Sincronizando IcDesk.cs y IC-Desk.exe hacia servidor SV1 (irm)...")
    ...
    subprocess.run("scp -i /home/ingcrea/.ssh/sv1.sercommx.com -P 7365 -o StrictHostKeyChecking=no /home/ingcrea/github/ic-desk/Windows/IC-Desk.exe ubuntu@129.159.72.206:/tmp/IC-Desk.exe", shell=True)
    subprocess.run("ssh -i /home/ingcrea/.ssh/sv1.sercommx.com -p 7365 -o StrictHostKeyChecking=no ubuntu@129.159.72.206 'sudo mv /tmp/IcDesk.cs /home/alex/alex_omega/whatsapp_sovereign/IcDesk.cs && sudo chown alex:alex /home/alex/alex_omega/whatsapp_sovereign/IcDesk.cs && sudo mv /tmp/IC-Desk.exe /home/alex/alex_omega/whatsapp_sovereign/IC-Desk.exe && sudo chown alex:alex /home/alex/alex_omega/whatsapp_sovereign/IC-Desk.exe'", shell=True)
